...
const Home = () => {
  ...
  async function fetchAndLoadStores() {
    try {
      ...
      setStores([]);
      setErrorMessage('500: Det gick inte att hämta informationen');
    } finally {
      setIsLoading(false);
    }
  }
  ...
  return (
    <>
      <h1 className="text-md mt-14 text-center mx-4 lg:text-2xl">
        Välj en alkoholhaltig dryck och sedan &#x1F37B;
      </h1>
      <h2 className="text-xs md:text-md mt-3 text-center text-gray-500 mx-4">
        ...och sedan få information i vilka butiker i din stad den finns.
      </h2>
